...
Every PROFILE_DATA column name used anywhere should be spelled once,
...
LAB_TEST_CD = "TEST_TYPE_CD"
LAB_TEST_DESCR = "TEST_TYPE_DESCR"
LAB_COLLECT_DT = "SPECIMEN_COLLECT_DT"
