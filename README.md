...
`figS3_combined_scatter_modality_text` (each modality alone vs. with text, five facets in one
row at full slide width) and `figS3_combined_scatter_all_text` (all except text vs. all modalities, beside all
