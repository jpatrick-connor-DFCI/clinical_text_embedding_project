...
10 × 8.2 inches, with 600-dpi PNGs and vector PDFs. Compiled artwork has no panel
letters, and KM curves have no number-at-risk tables. Captions identify panels
by position. Each compiled figure also gets a `_captioned` PNG/PDF review copy;
