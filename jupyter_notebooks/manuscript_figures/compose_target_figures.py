...
FIGURE_SPECS: dict[str, FigureSpec] = {
    "1": FigureSpec(
        ...
        size=(16.0, 14.0),
        panels=(
            PanelSlot("A", "fig1a", (0.04, 0.69, 0.60, 0.27)),
            PanelSlot("B", "fig1b", (0.70, 0.69, 0.26, 0.27)),
            PanelSlot("C", "fig1c", (0.06, 0.38, 0.40, 0.25)),
            PanelSlot("D", "fig1d", (0.56, 0.38, 0.38, 0.25)),
            PanelSlot("E", "fig1e", (0.06, 0.05, 0.40, 0.25)),
            PanelSlot("F", "fig1f", (0.56, 0.05, 0.38, 0.25)),
        ),
    ),
    "2": FigureSpec(
        key="2",
        ...
        size=(15.5, 16.8),
        panels=(
            PanelSlot("A", "fig2a", (0.05, 0.78, 0.40, 0.18)),
            PanelSlot("B", "fig2b", (0.56, 0.78, 0.38, 0.18)),
            PanelSlot("C", "fig2c", (0.08, 0.55, 0.84, 0.18)),
            PanelSlot("D", "fig2d", (0.05, 0.30, 0.90, 0.19)),
            PanelSlot("E", "fig2e", (0.05, 0.04, 0.90, 0.19)),
        ),
    ),
    "3": FigureSpec(
        key="3",
    ...
    "s1": FigureSpec(
        key="s1",
        stem="figureS1_cluster_silhouette",
        size=(7.0, 5.5),
        panels=(
            PanelSlot("", "figS1a", (0.10, 0.10, 0.82, 0.82)),
        ),
    ),
    "5": FigureSpec(
        key="5",
        ...
        size=(15.5, 17.0),
        panels=(
            PanelSlot("A", "fig5a", (0.05, 0.71, 0.42, 0.25)),
            PanelSlot("B", "fig5d", (0.54, 0.69, 0.42, 0.27)),
            PanelSlot("C", "fig5b", (0.20, 0.39, 0.55, 0.26)),
            PanelSlot("D", "fig5c", (0.04, 0.05, 0.92, 0.26)),
        ),
    ),
}
