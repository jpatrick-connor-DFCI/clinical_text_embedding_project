...
- **Disease-severity characteristics (Fig 4C).** Panel C is a 1×4 small-multiples row (% Stage IV, % ICI treated, mean # metastatic sites, **5-yr RMST** in months) reading `fig4_cluster_severity.csv`; RMST (`restricted_mean_survival_time`, τ=60 mo) is always defined under censoring.
