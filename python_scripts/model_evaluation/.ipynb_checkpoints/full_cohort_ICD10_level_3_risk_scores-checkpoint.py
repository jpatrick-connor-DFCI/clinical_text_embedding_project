...
FULL_COHORT_PATH = os.path.join(RESULTS_PATH, 'icd10_level_3_full_cohort/')
FEATURE_COMPS_PATH = os.path.join(RESULTS_PATH, 'icd10_level_3_complete_model/')
HELD_OUT_PATH = os.path.join(RESULTS_PATH, 'icd10_level_3_held_out_preds_full_cohort/')
