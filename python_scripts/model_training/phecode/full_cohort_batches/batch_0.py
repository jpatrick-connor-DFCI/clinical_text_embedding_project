...
OUTPUT_PATH = os.path.join(RESULTS_PATH, 'phecode_results/full_cohort_high_iter/')
os.makedirs(OUTPUT_PATH, exist_ok=True)

os.environ["JOBLIB_DEFAULT_WORKER_TIMEOUT"] = "600"

# Load text data
time_decayed_events_df = pd.read_csv(os.path.join(SURV_PATH, 'phecode_embedding_prediction_df.csv'))
