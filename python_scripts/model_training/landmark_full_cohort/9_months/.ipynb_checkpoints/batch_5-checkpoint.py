...
OUTPUT_PATH = os.path.join(RESULTS_PATH, 'icd10_level_3_full_cohort_plus_9_months/')
os.makedirs(OUTPUT_PATH, exist_ok=True)

os.environ["JOBLIB_DEFAULT_WORKER_TIMEOUT"] = "600"

# Load text data
time_decayed_events_df = pd.read_csv(os.path.join(SURV_PATH, 'time-to-icd/time_decayed_events_9_month_post_df.csv'))
