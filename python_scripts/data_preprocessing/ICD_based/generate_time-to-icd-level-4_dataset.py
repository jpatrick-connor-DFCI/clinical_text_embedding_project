...
split_ehr_icd_subset['ICD10_LEVEL_4_CD'] = split_ehr_icd_subset['DIAGNOSIS_ICD10_CD'].map(_to_icd10_level_4)
split_ehr_icd_subset = split_ehr_icd_subset.loc[
    split_ehr_icd_subset['ICD10_LEVEL_4_CD'].isin(set(icds_to_analyze))
].copy()
...
for icd in tqdm(icds_to_analyze, desc="Generating level-4 ICD events"):
    icd_data_sub = split_ehr_icd_subset.loc[split_ehr_icd_subset['ICD10_LEVEL_4_CD'] == icd]
