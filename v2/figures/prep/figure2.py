...
# code_data/ (CODE_PATH) holds code lookups regenerated by this pipeline before
# figure data are prepared.
CODE_LOOKUP_GENERATORS = (
    V2_ROOT / "pipelines/preprocessing/generate_icd10_to_phecode_mapping.R",
    V2_ROOT / "pipelines/preprocessing/generate_phecode_descriptions.R",
)
