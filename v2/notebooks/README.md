...
| 04b | `04b_run_training_manifests.ipynb` | allocated Jupyter CPU session | Resumable treatment-anchor fallback runner for the full-cohort, feature-comparison, and held-out-risk manifests when Slurm array submission is unavailable. Run **04** first; do not execute 04b on a login node. |
