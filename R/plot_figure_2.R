...
save_panel(p2c, paste0("fig2c", .tag), group = "figure2", width = 7.6, height = 6.0)
save_panel(p2d, paste0("fig2d", .tag), group = "figure2", width = 7.6, height = 6.0)
save_compiled_figure(
  list(a = p2a, b = p2b, c = p2c, d = p2d),
  number = 2, width = 18, height = 14
)
